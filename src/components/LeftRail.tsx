...
export function LeftRail() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 h-full border-r border-dark-border bg-dark-card/30 backdrop-blur-xl">
      {/* Logo */}
          ...
          {topics.map((topic) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <motion.span layoutId="topic-active-dot" className="ml-auto w-1.5 h-1.5 rounded-full bg-violet-400" />
                )}
              </button>
            )
          })}
        ...
        {user ? (
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <button onClick={() => signOut()} className="text-xs text-dark-muted hover:text-red-400 transition-colors">
                Sign out
              </button>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-dark-bg/60 border border-dark-border text-dark-muted hover:text-white transition-colors text-sm"
            >
