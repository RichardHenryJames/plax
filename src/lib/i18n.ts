...
const EN: Dict = {
  ...
  listen: 'Listen',
  listenStop: 'Stop',
  listenUnsupported: 'Audio not supported on this device',
  ...
  moreByAuthorLoading: 'Finding books…',
...
const HI: Dict = {
  ...
  listen: 'सुनें',
  listenStop: 'रोकें',
  listenUnsupported: 'इस डिवाइस पर ऑडियो समर्थित नहीं है',
  ...
  moreByAuthor: 'इस लेखक की और किताबें',
  moreByAuthorLoading: 'किताबें खोज रहे हैं…',
