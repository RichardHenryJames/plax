...
export const TOPIC_WIKI_QUERIES: Record<string, string[]> = {
  ...
  psychology: ['cognitive psychology', 'human behavior', 'cognitive bias', 'memory', 'emotion'],
  history: ['ancient civilization', 'world history', 'historical figure', 'ancient history', 'empire'],
  finance: ['personal finance', 'investing', 'stock market', 'economics', 'compound interest'],
  space: ['solar system', 'black hole', 'space exploration', 'galaxy', 'exoplanet'],
